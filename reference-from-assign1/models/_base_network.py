...
class _baseNetwork:
    ...
    def softmax(self, scores):
        ...
        #############################################################################
        #print(scores)
        ex = np.exp(scores - np.max(scores, axis=1, keepdims=True))
        #print(ex)
    ...
    def cross_entropy_loss(self, x_pred, y):
        ...
        y_one_hot = np.eye(x_pred.shape[1])[y]
        #print("x_pred:", x_pred)
        #print("y_one_hot:", y_one_hot)
        loss = -np.sum(y_one_hot * np.log(x_pred)) / N
    ...
    def compute_accuracy(self, x_pred, y):
        ...
        #############################################################################
        N = x_pred.shape[0]
        acc = np.sum(np.argmax(x_pred, axis=1) == y) / N
